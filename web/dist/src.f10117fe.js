...
exports.User = User;
},{"./Attributes":"src/models/Attributes.ts","./ApiSync":"src/models/ApiSync.ts","./Eventing":"src/models/Eventing.ts","./Model":"src/models/Model.ts","./Collection":"src/models/Collection.ts"}],"src/views/CollectionView.ts":[function(require,module,exports) {
"use strict";
...
var User_1 = require("./models/User"); // import { UserEdit } from './views/UserEdit';
...
users.on('change', function () {
  ...
  if (rootElement) {
    new UserList_1.UserList(rootElement, users).render();
...
users.fetch();
},{"./models/User":"src/models/User.ts","./views/UserList":"src/views/UserList.ts","./models/Collection":"src/models/Collection.ts"}],"../../../.nvm/versions/node/v14.15.4/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
